...
###############################################################################
# Class Animal
# Descrption: This class describes the basic animal attributes and methods
###############################################################################
class Animal(object):
###############################################################################
# __init__
# Descrption: This function initializes a new animal object.
# Arguments: this_color - The color this animal should be represented as
#            blank_color - The backround color that signifies a space is unoccupied
...
###############################################################################
# __decideDirection
# Descrption: This function decides how the animal should move next.
...
# Returns: The chosen direction.  This direction is guarenteed to be a valid move
###############################################################################
...
###############################################################################
# move
# Descrption: This function moves the animal one space in the direction decided by __decideDirection
...
# Class Prey
# Parent: Animal
# Descrption: This class inherits from Animal and overloads the some of
...
###############################################################################
# __init__
# Descrption: This function initializes a new predator object.  It is
