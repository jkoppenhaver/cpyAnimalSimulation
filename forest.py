...
predators = []
predators.append(Animals.Predator(WOLF_COLOR, BLANK_COLOR, RABBIT_COLOR, pdata))
predators.append(Animals.Predator(BEAR_COLOR, BLANK_COLOR, RABBIT_COLOR, pdata))
#Generate a list to hold all of the rabbits and add a bunch of them
prey = []
prey.append(Animals.Prey(RABBIT_COLOR, BLANK_COLOR, pdata))
prey.append(Animals.Prey(RABBIT_COLOR, BLANK_COLOR, pdata))
prey.append(Animals.Prey(RABBIT_COLOR, BLANK_COLOR, pdata))
prey.append(Animals.Prey(RABBIT_COLOR, BLANK_COLOR, pdata))
