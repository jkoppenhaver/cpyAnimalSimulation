...
predators = [Animals.Predator(WOLF_COLOR, BLANK_COLOR, RABBIT_COLOR, pdata),
             Animals.Predator(BEAR_COLOR, BLANK_COLOR, RABBIT_COLOR, pdata)]
# Generate a list to hold all of the rabbits and add a bunch of them
prey = [Animals.Prey(RABBIT_COLOR, BLANK_COLOR, pdata), Animals.Prey(RABBIT_COLOR, BLANK_COLOR, pdata),
        Animals.Prey(RABBIT_COLOR, BLANK_COLOR, pdata), Animals.Prey(RABBIT_COLOR, BLANK_COLOR, pdata)]
